...
public class Goto extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public Goto(eu.rawfie.uxv.commands.Header header, eu.rawfie.uxv.commands.Location location, java.lang.Float speed, java.lang.Float timeout) {
    this.header = header;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: header = (eu.rawfie.uxv.commands.Header)value$; break;
   ...
   */
  public eu.rawfie.uxv.commands.Header getHeader() {
    return header;
  }
   ...
   */
  public void setHeader(eu.rawfie.uxv.commands.Header value) {
    this.header = value;
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Goto>
    ...
    /** Message header */
    private eu.rawfie.uxv.commands.Header header;
    private eu.rawfie.uxv.commands.Header.Builder headerBuilder;
    /** Desired location */
    private eu.rawfie.uxv.commands.Location location;
    ...
    private Builder(eu.rawfie.uxv.commands.Goto.Builder other) {
      ...
      if (other.hasHeaderBuilder()) {
        this.headerBuilder = eu.rawfie.uxv.commands.Header.newBuilder(other.getHeaderBuilder());
      }
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.uxv.commands.Goto.Builder setHeader(eu.rawfie.uxv.commands.Header value) {
     ...
     * @return This builder.
     */
    public eu.rawfie.uxv.commands.Header.Builder getHeaderBuilder() {
      if (headerBuilder == null) {
        if (hasHeader()) {
          setHeaderBuilder(eu.rawfie.uxv.commands.Header.newBuilder(header));
        } else {
          setHeaderBuilder(eu.rawfie.uxv.commands.Header.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public eu.rawfie.uxv.commands.Goto.Builder setHeaderBuilder(eu.rawfie.uxv.commands.Header.Builder value) {
      clearHeader();
      headerBuilder = value;
      return this;
    }
    ...
    public Goto build() {
      try {
        ...
        if (headerBuilder != null) {
          ...
          record.header = fieldSetFlags()[0] ? this.header : (eu.rawfie.uxv.commands.Header) defaultValue(fields()[0]);
        }
        if (locationBuilder != null) {
