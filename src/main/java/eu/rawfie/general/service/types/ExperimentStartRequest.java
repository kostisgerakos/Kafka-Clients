...
public class ExperimentStartRequest extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5652403727655980355L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ExperimentStartRequest\",\"namespace\":\"eu.rawfie.general.service.types\",\"fields\":[{\"name\":\"executionId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"script\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"testbedId\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"isIndoor\",\"type\":\"boolean\",\"default\":false},{\"name\":\"resourceNames\",\"type\":{\"type\":\"array\",\"items\":\"string\"}},{\"name\":\"partitionids\",\"type\":{\"type\":\"array\",\"items\":\"int\"}},{\"name\":\"accuracy\",\"type\":\"double\",\"doc\":\"Desired accuracy for the waypoint-navigation procedure\",\"unit\":\"m\"},{\"name\":\"takeOffHeights\",\"type\":[\"null\",{\"type\":\"array\",\"items\":\"double\"}],\"doc\":\"Desired take off height - For UAVs only\",\"default\":null,\"unit\":\"m\"}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
   private java.lang.CharSequence executionId;
   private java.lang.CharSequence script;
   private java.lang.CharSequence testbedId;
   private boolean isIndoor;
   private java.util.List<java.lang.CharSequence> resourceNames;
   ...
   */
  public ExperimentStartRequest(java.lang.CharSequence executionId, java.lang.CharSequence script, java.lang.CharSequence testbedId, java.lang.Boolean isIndoor, java.util.List<java.lang.CharSequence> resourceNames, java.util.List<java.lang.Integer> partitionids, java.lang.Double accuracy, java.util.List<java.lang.Double> takeOffHeights) {
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: executionId = (java.lang.CharSequence)value$; break;
    case 1: script = (java.lang.CharSequence)value$; break;
    case 2: testbedId = (java.lang.CharSequence)value$; break;
    case 3: isIndoor = (java.lang.Boolean)value$; break;
    case 4: resourceNames = (java.util.List<java.lang.CharSequence>)value$; break;
   ...
   */
  public java.lang.CharSequence getExecutionId() {
    return executionId;
  }
   ...
   */
  public void setExecutionId(java.lang.CharSequence value) {
   ...
   */
  public java.lang.CharSequence getScript() {
    return script;
  }
   ...
   * @param value the value to set.
   */
  public void setScript(java.lang.CharSequence value) {
    this.script = value;
  }
   ...
   */
  public java.lang.CharSequence getTestbedId() {
    return testbedId;
  }
   ...
   * @param value the value to set.
   */
  public void setTestbedId(java.lang.CharSequence value) {
   ...
   */
  public java.util.List<java.lang.CharSequence> getResourceNames() {
   ...
   * @param value the value to set.
   */
  public void setResourceNames(java.util.List<java.lang.CharSequence> value) {
  ...
  /**
   * Creates a new ExperimentStartRequest RecordBuilder.
   * @return A new ExperimentStartRequest RecordBuilder
   */
  public static eu.rawfie.general.service.types.ExperimentStartRequest.Builder newBuilder() {
    return new eu.rawfie.general.service.types.ExperimentStartRequest.Builder();
  }

  /**
   * Creates a new ExperimentStartRequest RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new ExperimentStartRequest RecordBuilder
   */
  public static eu.rawfie.general.service.types.ExperimentStartRequest.Builder newBuilder(eu.rawfie.general.service.types.ExperimentStartRequest.Builder other) {
    return new eu.rawfie.general.service.types.ExperimentStartRequest.Builder(other);
  }

  /**
   * Creates a new ExperimentStartRequest RecordBuilder by copying an existing ExperimentStartRequest instance.
   * @param other The existing instance to copy.
   * @return A new ExperimentStartRequest RecordBuilder
   */
  public static eu.rawfie.general.service.types.ExperimentStartRequest.Builder newBuilder(eu.rawfie.general.service.types.ExperimentStartRequest other) {
    return new eu.rawfie.general.service.types.ExperimentStartRequest.Builder(other);
  }

  /**
   * RecordBuilder for ExperimentStartRequest instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ExperimentStartRequest>
    implements org.apache.avro.data.RecordBuilder<ExperimentStartRequest> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(eu.rawfie.general.service.types.ExperimentStartRequest.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing ExperimentStartRequest instance
     * @param other The existing instance to copy.
     */
    private Builder(eu.rawfie.general.service.types.ExperimentStartRequest other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.executionId)) {
        this.executionId = data().deepCopy(fields()[0].schema(), other.executionId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setExecutionId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearExecutionId() {
      executionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setScript(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearScript() {
      script = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setTestbedId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearTestbedId() {
      testbedId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setIsIndoor(boolean value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearIsIndoor() {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setResourceNames(java.util.List<java.lang.CharSequence> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearResourceNames() {
      resourceNames = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setPartitionids(java.util.List<java.lang.Integer> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearPartitionids() {
      partitionids = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setAccuracy(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearAccuracy() {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder setTakeOffHeights(java.util.List<java.lang.Double> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public eu.rawfie.general.service.types.ExperimentStartRequest.Builder clearTakeOffHeights() {
      takeOffHeights = null;
    ...
    @Override
    public ExperimentStartRequest build() {
      try {
        ExperimentStartRequest record = new ExperimentStartRequest();
        record.executionId = fieldSetFlags()[0] ? this.executionId : (java.lang.CharSequence) defaultValue(fields()[0]);
        record.script = fieldSetFlags()[1] ? this.script : (java.lang.CharSequence) defaultValue(fields()[1]);
        record.testbedId = fieldSetFlags()[2] ? this.testbedId : (java.lang.CharSequence) defaultValue(fields()[2]);
        record.isIndoor = fieldSetFlags()[3] ? this.isIndoor : (java.lang.Boolean) defaultValue(fields()[3]);
        record.resourceNames = fieldSetFlags()[4] ? this.resourceNames : (java.util.List<java.lang.CharSequence>) defaultValue(fields()[4]);
